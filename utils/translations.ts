export const translations = {
    id: {
        ...
        settings: "Pengaturan",
        about: "Tentang",
        aboutContent: "Halaman ini bertujuan untuk memodifikasi Avatar 3D berekstensi VRM. Terima kasih telah menggunakan.",
        aboutReadme: "Untuk info selengkapnya, silahkan kunjungi halaman readme.",
        btnViewReadme: "Lihat readme",
        subtitleNote: "Catatan",
        noteContent: "Pastikan Anda sudah mematuhi ketentuan dan pedoman dari setiap pemilik VRM.",
        btnViewDisclaimer: "Lihat Kepatuhan dan Penafian",
        subtitleCredits: "Kredit",
        creditsFont: "Font:",
        creditsFontDetails: "Poppins - Indian Type Foundry, Jonny Pinhorn, dan Ninad Kale",
        creditsThirdParty: "Perpustakaan pihak ketiga:",
        creditsThreeJs: "Three.js - Pustaka 3D inti yang digunakan untuk rendering.",
        creditsPixiv: "@pixiv/three-vrm - Pustaka resmi untuk menangani file VRM.",
        creditsReact: "React - Pustaka JavaScript untuk membangun antarmuka pengguna.",
        creditsVite: "Vite - Perangkat Pengembangan Frontend Generasi Berikutnya.",
        creditsHeroicons: "Heroicons - Untuk ikon di situs web ini.",
        subtitleVersion: "Versi Website",
        languageSettings: "Pilihan Bahasa",
        allDisplayContent: "Semua Konten Tampilan",
    ...
    en: {
        ...
        creditsFont: "Font:",
        creditsFontDetails: "Poppins - Indian Type Foundry, Jonny Pinhorn, and Ninad Kale",
        creditsThirdParty: "Third-party libraries:",
        creditsThreeJs: "Three.js - The core 3D library used for rendering.",
        creditsPixiv: "@pixiv/three-vrm - Official library for handling VRM files.",
        creditsReact: "React - The JavaScript library for building the user interface.",
        creditsVite: "Vite - Next Generation Frontend Tooling.",
        creditsHeroicons: "Heroicons - For icons on this website.",
        subtitleVersion: "Website Version",
        languageSettings: "Language Options",
        allDisplayContent: "All Display Content",
        moreMenu: "More Menu",
        nav: {
            body: "Body",
            display: "Display",
